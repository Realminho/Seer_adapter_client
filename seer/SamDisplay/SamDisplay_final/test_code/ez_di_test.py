...
def main():
    ...
    dio = DIO_Commu(ip="192.168.0.12", port=2001, timeout=5.0)
    ...
    try:
        ...
        # DI 4번 상태 읽기
        di_4_info = dio.read_di(4)

        # DI 6번 상태 읽기
        di_6_info = dio.read_di(6)

        # DI 4번 상태 출력
        print(f"[EZI-IO] DI 4번 상태 : {di_4_info}")

        # DI 6번 상태 출력
        print(f"[EZI-IO] DI 12번 상태 : {di_6_info}")
